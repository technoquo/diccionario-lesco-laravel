...
<div class="flex float-left top_left_super">
    ...
    <div class="flex justify-center pt-20">
        ...
        <form action="/admin/categorias/update" style="box-shadow:-50px -4px 50px #f0f0f0;" method="POST">
            @csrf
            <input type="hidden" value="{{ $cat->cod_categoria }}" name="cod_categoria"/>
            <div class="py-12 px-8">
                <h2 class="text-2xl font-bold">Actualizar categoría</h2>
                      ...
                      value="{{ $cat->categoria }}"
                        ...
                        <div class="block">
                            ...
                            focus:ring-1 focus:ring-offset-2 focus:ring-gray-500"
                                            name="estado"   name="estado" @if ($cat->estado == 'A') checked @endif>
