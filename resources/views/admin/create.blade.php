...
<div class="flex float-left top_left_super">
    ...
    <div class="flex justify-center pt-20">
        ...
        <form action="/admin" style="box-shadow:-50px -4px 50px #f0f0f0;" method="POST">
            @csrf
            <div class="py-12 px-8">
                <h2 class="text-2xl font-bold">Crear una nueva palabra para la seña</h2>
                <div class="mt-8 max-w-md">
                    <div class="grid grid-cols-1 gap-6">
                      ...
                      h-10"
                        ...
                        h-10
                        uppercase"
                        name="letra" autocomplete="off" maxlength="1">
                        </label>
                        <div class="block">
                            <div class="mt-2">
                                <div>
