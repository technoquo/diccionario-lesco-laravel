                ...
                <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST" action="{{ route('password.confirm') }}">
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <input id="password" type="password"
                            class="form-input border-2 w-full @error('password') border-red-500 @enderror" name="password"
                    ...
                    <div class="flex flex-wrap justify-center items-center space-y-6 pb-6 sm:pb-10 sm:space-y-0 sm:justify-between">
                        <button type="submit"
                        class="form-input border-2 select-none font-bold whitespace-no-wrap p-3 rounded-lg text-base leading-normal no-underline text-gray-100 bg-blue-500 hover:bg-blue-700 sm:w-auto sm:px-4 sm:order-1">
                            {{ __('Confirm Password') }}
                        </button>
